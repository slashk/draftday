...
do {
	$sPlayerRaw="";
	$ch = curl_init ("http://baseball.fantasysports.yahoo.com/b1/2860/players?status=A&pos=B&cut_type=33&stat1=S_S_2006&sort=AR&count=$count");
...
$sSQL = "INSERT INTO mlb07_batters (ID,Player,Team,Pos,ORank,Rank,H,R,HR,RBI,SB,AVG) VALUES\n";
$sSQL = $sSQL . $sPlayerList;
echo $sSQL;
echo ";\n";
//write the  sql file
	//$fp = fopen("/home/pivo/www/sandbox/07batters.sql", "w");
	//fwrite ($fp, $sSQL);
	//fclose($fp);
?>
